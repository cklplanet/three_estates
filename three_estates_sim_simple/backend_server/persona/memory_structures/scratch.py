...
class Scratch: 
  ...
  def __init__(self, role, f_saved=False): 
    ...
    self.movement_reflection_count = 0
    ...
    if check_if_file_exists(f_saved):
        ...
        self.movement_reflection_count = scratch_load.get("movement_reflection_count", self.movement_reflection_count)
  ...
  def save(self, out_json):
    ...
    scratch["movement_reflection_count"] = self.movement_reflection_count
